    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        /*$this->smtp_params['host'] = 'smtp.itatiaiapremium.com.br';
        $this->smtp_params['port'] = 25;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = TRUE;
        $this->smtp_params['user'] = 'itatiaia@itatiaiapremium.com.br';
        $this->smtp_params['pass'] = 'ita456';*/
        
        $this->smtp_params['host'] = 'mail.timbredegalo.com.br';
        $this->smtp_params['port'] = 25;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = TRUE;
        $this->smtp_params['user'] = 'contatosite@timbredegalo.com.br';
        $this->smtp_params['pass'] = 'timbre$cont#';
